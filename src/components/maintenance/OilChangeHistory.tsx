...
export function OilChangeHistory({ records }: { records: MaintenanceRecord[] }) {
  ...
  if (records.length === 0) {
    return (
      ...
      >
        <Text style={[styles.emptyTitle, { color: colors.text }]}>No oil changes recorded</Text>
        <Text style={[styles.emptyText, { color: colors.textMuted }]}>Use “Mark Oil Changed” after completing an oil change.</Text>
      </View>
    );
  }
